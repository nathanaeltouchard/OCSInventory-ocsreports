...
mysql --login-path=jenkins --force <<EOF # connect to mysql (EOF is used to enter multiple requests on mysql simultaneously on standard input, while EOF isn't read)
